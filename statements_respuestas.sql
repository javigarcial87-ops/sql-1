...
-- Tu respuesta aquí
FROM (SELECT DISTINCT id_usuario, edad FROM usuarios_lenguajes WHERE lenguaje = 'Java') AS subconsulta;
...
-- Tu respuesta aquí
SELECT ID_USUARIO, COUNT(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes GROUP BY ID_USUARIO;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE edad < 30 ORDER BY CHAR_LENGTH(lenguaje) DESC;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS total_usuarios FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 30;
...
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes WHERE edad >= 30 ORDER BY CHAR_LENGTH(lenguaje) DESC;


-- Ejercicio 35: Seleccionar los usuarios y mostrar la diferencia entre su edad y la edad promedio de todos los usuarios
-- Tu respuesta aquí
SELECT id_usuario, edad, edad - (SELECT AVG(edad) FROM usuarios_lenguajes) AS diferencia_edad FROM usuarios_lenguajes;
...
-- Tu respuesta aquí
SELECT lenguaje, nombre, id_usuario FROM usuarios_lenguajes ORDER BY id_usuario DESC;
